...
public class TestObjectMark {
	...
	public TestObjectMark(String strType, int x, int y){
		...
		{
			icon = new ImageIcon(TestObjectMark.class.getResource("Door.png"));
		...
		{
			icon = new ImageIcon(TestObjectMark.class.getResource("Window.png"));
		...
		{
			icon = new ImageIcon(TestObjectMark.class.getResource("Corridor.png"));
